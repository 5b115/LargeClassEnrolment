...
<div class="logintop">    
   ...
   <%
    ...
    <form action="login" method="post">
    	...
    	<ul>
    	<li></li>
	    <li><input name="mname" type="text" placeholder="用户名" class="loginuser"  /></li>
	    <li><input name="mpassword" type="password" placeholder="密码" class="loginpwd"  /></li>
	    <li class="yzm">
    ...
    <div class="loginbm">版权所有 吴帆  <a href="http://www.uimaker.com">uimaker.com</a>  仅供学习交流，勿用于任何商业用途</div>
